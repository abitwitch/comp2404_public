...
int main(void){
  ...
  //readInputs.push("delete -u gob");
  //readInputs.push("add -u gob \"George Oscar Bluth\"");
  //readInputs.push("show songs");
  //readInputs.push("show users");
  //readInputs.push("show playlists -u ajones");
  //readInputs.push("show songs -u ajones -p driving");
  //readInputs.push("show recordings");
  //readInputs.push("show tracks");
  //readInputs.push("delete -u gob");

  readInputs.push(".read test_01_add_populate.txt");
  //readInputs.push(".read test_04_delete.txt");
  //readInputs.push(".quit");
